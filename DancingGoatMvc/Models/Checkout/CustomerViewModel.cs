...
namespace DancingGoat.Models.Checkout
{
    public class CustomerViewModel
    {
        ...
        [MaxLength(26, ErrorMessage = "DancingGoatMvc.General.MaximumInputLengthExceededed")]
        public string PhoneNumber { get; set; }


        [Display(Name = "DancingGoatMvc.CompanyName")]
        [MaxLength(200, ErrorMessage = "DancingGoatMvc.General.MaximumInputLengthExceededed")]
        public string Company { get; set; }


        [Display(Name = "DancingGoatMvc.OrganizationId")]
        [MaxLength(50, ErrorMessage = "DancingGoatMvc.General.MaximumInputLengthExceededed")]
